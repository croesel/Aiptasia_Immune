...
kableIn <- kable(barPlotTable4, 
                 ...
                 format="html", booktabs=T, longtable=F, row.names = F, col.names = colRename, align="l") %>% 
...
Vibrio, "html", color = "white", bold = T,
...
Menthol, "html", color = "white", bold = T,
...
colHdr <- c("Gene","Symbol", "Pathway", "Group", "Vibrio", "Menthol")
kableIn <- kable(dfHeatmap4, col.names = colHdr, caption=caption,booktab=T, 
                 format='html', escape=F, longtable=F, digits=2, row.names=T) %>% 
            kable_styling(font_size=9, full_width = F) %>%  
            column_spec(1, color = "white")%>%  column_spec(4, width = "30em")%>% 
            column_spec(6, width = "3em")%>% column_spec(7, width = "3em")
