...
```
```{r HeatBySelCategoryLFC0, fig.cap="Heatmap by Selected Category abs(LFC) > 0", fig.height=10, fig.path='Figures/', fig.width=10, message=FALSE, warning=FALSE, dev=c('png', 'pdf', 'svg')}
#par(mfrow=c(1,3))
...
write.table(latexTablesLFC1$sharedGenePathSel2, file="latexTablesLFC1$sharedGenePathSel2.tsv", quote=F, sep="\t")
write.csv(latexTablesLFC1$sharedGenePathSel2, file="latexTablesLFC1$sharedGenePathSel2.csv")
